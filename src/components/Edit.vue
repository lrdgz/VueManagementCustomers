...
<script>
    ...
    methods: {
        fetchCustomer(id){
            this.$http.get('http://127.0.0.1/CustomerMagmentApi/public/api/customer/'+id)
        ...
        updateCustomer(e){
            if(!this.customer.first_name || !this.customer.last_name || !this.customer.email){
                ...
                this.$http.put('http://127.0.0.1/CustomerMagmentApi/public/api/customer/update/'+this.$route.params.id, updCustomer)
                    .then(function(response){
